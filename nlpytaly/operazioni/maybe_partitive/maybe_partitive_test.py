...
def test2(tagger):
    ...
    assert tags[-2].pos == "DET:part"
    assert tags[-1]._ruolo_sintattico == "PN"
...
def test12(tagger):
    ...
    assert tags[-2].pos == "PRE:det"
    assert tags[0]._ruolo_sintattico == "SOGG"
...
def test13(tagger):
    ...
    assert tags[0].pos == "DET:part"
    assert tags[0]._ruolo_sintattico == "SOGG"
    assert tags[1]._ruolo_sintattico == "SOGG"
...
def test14(tagger):
    ...
    assert tags[2]._ruolo_sintattico == "SOGG"
    assert tags[3]._ruolo_sintattico == "SOGG"
